...
class TestList:
    ...
    @pytest.fixture
    def user_config(
        self, user_id_1, user_id_2, alert_config_1, alert_config_2, alert_config_3, alert_id_1, alert_id_2, alert_id_3
    ):
        return {
            "userConfigs": {
                user_id_1: {
    ...
    def test_enact(self, make_event, user_config_provider, alert_config_1, user_id_1, alert_id_1):
        ...
        assert len(result) == 1
        TestCase().assertDictEqual(result[0], {"userId": user_id_1, "alertId": alert_id_1, **alert_config_1})

    def test_enact_multiple(
        self, make_event, user_config_provider, alert_config_2, alert_config_3, user_id_2, alert_id_2, alert_id_3
    ):
        ...
        assert len(result) == 2
        TestCase().assertDictEqual(result[0], {"userId": user_id_2, "alertId": alert_id_2, **alert_config_2})
        TestCase().assertDictEqual(result[1], {"userId": user_id_2, "alertId": alert_id_3, **alert_config_3})
